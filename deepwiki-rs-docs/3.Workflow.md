...
`codekeeper` is a **patch-and-mod management repository** that customizes an externally installed vLLM inference stack without forking it. Its workflows operate at two fundamentally different layers that must be understood together:
